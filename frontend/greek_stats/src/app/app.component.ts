  ...
  ngOnInit(): void {
    ...
    this.menuItems = [
      { label: 'Κατάλογος Dataset - Τουρισμός', icon: 'pi pi-home', routerLink: '/' },
      {
        ...
        icon: 'pi pi-globe',
        items: [
          { label: 'Δαπάνη ανά ταξίδι μη κατοίκων στην Ελλάδα κατά χώρα προέλευσης (Τριμηνιαία)', icon: 'pi pi-map', routerLink: '/tourism' },
          { label: 'Δαπάνη ανά ταξίδι κατοίκων στο εξωτερικό κατά χώρα προορισμού (Ετήσια)', icon: 'pi pi-map', routerLink: '/about-us' },
